...
const en: Record<string, string> = {
  ...
  "管理导出引擎、附件转换依赖和本机资源。侧栏只保留摘要，这里放完整处理入口。": "Manage the export engine, attachment conversion dependencies, and local resources. The sidebar keeps the summary; full actions live here.",
  ...
  "GUI 不内置 imessage-exporter；请选择本机已有的可执行文件，或打开下载页获取最新版。": "The GUI does not bundle imessage-exporter. Choose an existing executable on this computer, or open the download page for the latest version.",
